...
ActiveRecord::Schema.define(version: 20170919054651) do
  ...
  create_table "school_yearly_stats", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "school_id",                     null: false, comment: "NCES public school ID"
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.index ["school_id", "school_year"], name: "index_school_yearly_stats_on_school_id_and_school_year", unique: true, using: :btree
  end
  ...
  create_table "schools", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.string   "location_line1",     limit: 30,              comment: "Location address, street 1"
    t.string   "location_line2",     limit: 30,              comment: "Location address, street 2"
    t.string   "location_line3",     limit: 30,              comment: "Location address, street 3"
